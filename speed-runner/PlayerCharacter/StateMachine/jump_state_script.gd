...
var walljump_y_velocity : float = 9.0
...
func jump() -> void: 
	...
	var jump_velocity: float = (2.0 * play_char.jump_height) / play_char.jump_time_to_peak
...
func walljump() -> void:
	...
	play_char.set_vertical(walljump_y_velocity)
